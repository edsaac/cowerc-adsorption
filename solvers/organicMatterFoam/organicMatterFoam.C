    ...
    while (simple.loop(runTime))
    {
	    ...
	    // Aqueous phase of PFOA
            ...
            (
                ...
                + fvm::div(phi, pfoa_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, pfoa_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_pfoa * porosity * site_blocking * pfoa_aq  // kat*C
	    ...
	    // Aqueous phase of PFHXA
            ...
            (
                ...
                + fvm::div(phi, pfhxa_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, pfhxa_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_pfhxa * porosity * site_blocking * pfhxa_aq  // kat*C
	    ...
	    // Aqueous phase of PFHXS
            ...
            (
                ...
                + fvm::div(phi, pfhxs_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, pfhxs_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_pfhxs * porosity * site_blocking * pfhxs_aq  // kat*C
	    ...
	    // Aqueous phase of BEZ
            ...
            (
                ...
                + fvm::div(phi, bez_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, bez_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_bez * porosity * site_blocking * bez_aq  // kat*C
	    ...
	    // Aqueous phase of DCF
            ...
            (
                ...
                + fvm::div(phi, dcf_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, dcf_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_dcf * porosity * site_blocking * dcf_aq  // kat*C
	    ...
	    // Aqueous phase of PFBA
            ...
            (
                ...
                + fvm::div(phi, pfba_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, pfba_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_pfba * porosity * site_blocking * pfba_aq  // kat*C
	    ...
	    // Aqueous phase of GENX
            ...
            (
                ...
                + fvm::div(phi, genx_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, genx_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_genx * porosity * site_blocking * genx_aq  // kat*C
	    ...
	    // Aqueous phase of ORGANIC MATTER
            fvScalarMatrix Eq_OM_aq
            (
                fvm::ddt(porosity, OM_aq)     // d(n.C)/dt
                + fvm::div(phi, OM_aq)        // u. dC/dx --Adv
                - fvm::laplacian(DT, OM_aq)   // d²C/dx²  --Diff
             ==
                - k_adsorption_OM * porosity * site_blocking * OM_aq  // kat*C
                + k_desorption_OM * OM_ads  // kdet*S
                + fvOptions(OM_aq)
            );

            fvOptions.constrain(Eq_OM_aq);
            Eq_OM_aq.solve();
            fvOptions.correct(OM_aq);


            // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

            Info<< nl << "solidPhase solver" << nl << endl;
	    ...
	    // Adsorbed phase of PFOA
            ...
            (
             ...
             ==
                  k_adsorption_pfoa * porosity * site_blocking * pfoa_aq
                - k_desorption_pfoa * pfoa_ads
                + fvOptions(pfoa_ads)
            );
	    ...
	    // Adsorbed phase of PFHXA
            ...
            (
             ...
             ==
                  k_adsorption_pfhxa * porosity * site_blocking * pfhxa_aq
                - k_desorption_pfhxa * pfhxa_ads
                + fvOptions(pfhxa_ads)
            );
	    ...
	    // Adsorbed phase of PFHXS
            ...
            (
             ...
             ==
                  k_adsorption_pfhxs * porosity * site_blocking * pfhxs_aq
                - k_desorption_pfhxs * pfhxs_ads
                + fvOptions(pfhxs_ads)
            );
            ...
            (
             ...
             ==
                  k_adsorption_bez * porosity * site_blocking * bez_aq
                - k_desorption_bez * bez_ads
                + fvOptions(bez_ads)
            );
            ...
            (
             ...
             ==
                  k_adsorption_dcf * porosity * site_blocking * dcf_aq
                - k_desorption_dcf * dcf_ads
                + fvOptions(dcf_ads)
            );
            ...
            (
             ...
             ==
                  k_adsorption_pfba * porosity * site_blocking * pfba_aq
                - k_desorption_pfba * pfba_ads
                + fvOptions(pfba_ads)
            );
            ...
            (
             ...
             ==
                  k_adsorption_genx * porosity * site_blocking * genx_aq
                - k_desorption_genx * genx_ads
                + fvOptions(genx_ads)
            );
           ...
           // Adsorbed phase of ORGANIC MATTER
            fvScalarMatrix Eq_OM_ads
            (
                fvm::ddt(OM_ads)           // dS/dt
             ==
                  k_adsorption_OM * porosity * site_blocking * OM_aq
                - k_desorption_OM * OM_ads
                + fvOptions(OM_ads)
            );

            fvOptions.constrain(Eq_OM_ads);
            Eq_OM_ads.solve();
            fvOptions.correct(OM_ads);
        }
